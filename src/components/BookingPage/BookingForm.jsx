  ...
  return (
    <section className="checkout-section">
      <div className="page-container">
        ...
        {/* NOTA: Usa esattamente lo stesso componente CheckoutProgressBar */}
        <CheckoutProgressBar 
        ...
        <div className="checkout-container-vertical">
          <div className="checkout-form" aria-label="Reservation form">
            {renderStep()}
            ...
            <div className="checkout-actions">
              ...
              {/* MODIFICATO: Qui è importante assicurarsi che handleShowConfirmation sia chiamato correttamente */}
              {currentStep < 2 ? (
                <button 
                  type="button" 
                ...
                <button 
                type="button"
                onClick={() => handleShowConfirmation()} // Usa una funzione freccia!
